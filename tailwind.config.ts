...
const config: Config = {
  ...
  theme: {
    ...
    extend: {
      ...
      fontSize: {
        'display-2xl': ['4.5rem', { lineHeight: '1.1', fontWeight: '800', letterSpacing: '-0.02em' }],
        'display-xl': ['3.75rem', { lineHeight: '1.1', fontWeight: '800', letterSpacing: '-0.02em' }],
        'display-lg': ['3rem', { lineHeight: '1.2', fontWeight: '700', letterSpacing: '-0.01em' }],
        'display-md': ['2.25rem', { lineHeight: '1.25', fontWeight: '700', letterSpacing: '-0.01em' }],
